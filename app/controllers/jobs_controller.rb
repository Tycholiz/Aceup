class JobsController < ApplicationController
  ...
  def job_params
    params.require(:job).permit(
      :title, :jobType, :expiry, :general, :driversLicence, :hasVehicle, :status, :temp, :salary, :commDirect, :commResidual, :commLead, :payLow, :payHigh, :inSalesSoft, :inSalesHard, :outSalesSoft, :outSalesHard, :functions, :skills, :summary, :competencies, :deptSize, :coldCall, :doorToDoor, :custService, :acctManagment, :negotiation, :presenting, :leadership, :closing, :hunterBased, :farmerBased, :commBased, :B2C, :B2B, :consSales, :directSales, :solutionSales, :CompUrl, :educationLevel, :benefits, :languages => [], :certifications => []
    )                             
  end
